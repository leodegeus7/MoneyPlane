...
//  CoreData
//
//  Created by Leonardo Koppe Malanski on 02/07/15.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        DataManager.instance.getTransacoesDeUsuario("leo2")
...
//        }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.bepid.CoreData" in the application's documents Application Support directory.
